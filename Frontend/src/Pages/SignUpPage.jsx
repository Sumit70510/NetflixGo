       ...
       <div className='flex justify-center items-center mt-20 mx-3'>
         <div className='w-full max-w-md p-8 space-y-6 bg-black/75 rounded-lg shadow-md' >
           ...
           <form className='space-y-4' onSubmit={handleSignUp}>
            ...
            <input tpye='text' className='w-full px-3 py-2 int-1 border border-gray-700 rounded-md 
             bg-transparent text-white focus:outline-none focus-ring'
             placeholder='abcd1234' id='username' value={username} onChange={(e)=>setUsername(e.target.value)}/>
             </div>
             <div>
